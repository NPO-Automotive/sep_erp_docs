...
## Описание
Страница предназначена для отображения списка сборочных сущностей, заказанных на комплектацию. Он предоставляет пользователям возможность управлять этими сущностями, упрощая процесс комплектации и организации данных.
