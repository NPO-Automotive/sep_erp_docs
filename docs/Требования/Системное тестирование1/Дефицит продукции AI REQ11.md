...
Оно предоставляет пользователю актуальный список Изделий, находящихся в дефиците, с указанием количества в штуках.\
...
- **СВОЕ кол-во (по умолч. равно рекоменд. кол-ву)**
   - Свое кол-во для Изделий по умолчанию равняется Рекомендуемый остаток + Кол-во по Задачам на отгрузку - (кол-во на складе + кол-во на производстве)
